    ...
    <div class="full-box dashboard-sideBar-ct">
        ...
        <div class="full-box dashboard-sideBar-UserInfo">
            ...
            <ul class="full-box list-unstyled text-center">
                <?php if($_SESSION['userType'] == "Administrador" || $_SESSION['userType'] == "Profesor"): ?>
                <li>
        ...
        <ul class="list-unstyled full-box dashboard-sideBar-Menu">
            ...
            <?php endif; ?>
            <?php if($_SESSION['userType'] == "Profesor"): ?>
            <li>
            ...
            <li>
                <a href="#!" class="btn-sideBar-SubMenu">
                    <i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Profesores <i class="zmdi zmdi-caret-down pull-right"></i>
                </a>
                <ul class="list-unstyled full-box">
                    <li>
                        <a href="<?php echo SERVERURL; ?>teacher/">
                            <i class="zmdi zmdi-account-circle zmdi-hc-fw"></i> Nuevo
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo SERVERURL; ?>teacherlist/">
            ...
            <li>
                ...
                <ul class="list-unstyled full-box">
                    <li>
                        <a href="<?php echo SERVERURL; ?>course/">
                            <i class="zmdi zmdi-tv-alt-play zmdi-hc-fw"></i> Nueva
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo SERVERURL; ?>courselist/">
                            <i class="zmdi zmdi-tv-list zmdi-hc-fw"></i> Listado
                        </a>
                    </li>
                </ul>
